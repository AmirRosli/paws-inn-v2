...
export default function ReserveSuite() {
    ...
    const [roomType] = useState("Suite");
    const [price] = useState("75.00");
                        ...
                        <Form >
                            ...
                            <Typography variant="body2" color="text.secondary" className="typography-body">
                                <ul className="mt-3 mb-4">
                                    <li>Suitable and can fit up to 3-4 adult cats</li>
